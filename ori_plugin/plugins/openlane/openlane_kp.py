...
class OpenLaneKp(openpifpaf.datasets.DataModule):
    ...
    train_annotations = 'data-openlane/annotations/apollo_keypoints_66_train.json'
    val_annotations = 'data-openlane/annotations/apollo_keypoints_66_val.json'
    ...
    def cli(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument('--openlane-use-24-kps', default=False, action='store_true',
                           help=('The openlane dataset can '
